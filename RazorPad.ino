...
BleKeyboard BleKeyboard("Razorpad D1", "Razorbac", 69);

// ESP32 DEV Module 
int Button1 = 27; //UP
int Button2 = 25; //DOWN
int Button3 = 32; //LEFT
int Button4 = 12; //RIGHT
int Button5 = 4; //ENTER
int Button6 = 0; //F5 / BACK
int Button7 = 2; //F6 / ZOOM +
...
void setup() {
  // Serial
  Serial.begin(115200);
  Serial.println("Avvio RazorPad D1");
  // bleKeyboard
  BleKeyboard.begin();
  ...
  Serial.println("RazorPad D1 Avviato");
}
